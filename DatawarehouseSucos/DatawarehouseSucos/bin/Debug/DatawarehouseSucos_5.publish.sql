...
GO
PRINT N'Rename refactoring operation with key 4b8ca810-fae8-4868-a562-2bbd8be794fc is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key ba89e9e6-0cf2-4376-8287-a0198c9a4172 is skipped, element [dbo].[Fato_003].[Frete] (SqlSimpleColumn) will not be renamed to Custo_Fixo';
